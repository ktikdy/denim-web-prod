export const leaders = [
  ...
  {
    name: "Steffan Haithcox",
    title: "VP, Customer Engagement",
    image: "/images/team-member-4.png",
    description:
      "Steffan Haithcox has more than three decades of experience covering customer success, sales, marketing, and strategy - almost entirely in healthcare and health tech. He has a proven track record of driving growth in a variety of companies from VC-backed startups to mid-size PE portfolio companies to large, public enterprises. Steffan is currently VP of Customer Engagement at Denim Health and was previously Chief Marketing Officer at PerfectServe. He has also held leadership roles at bswift, Lawson, and AeroScout. Steffan has a BA from Swarthmore College and an MBA from Harvard Business School.",
  },
  {
    name: "Gokberk Yar",
  ...
  },
  {
    ...
    description:
      "Amy Bodin is a seasoned Operations and Strategy leader with over three decades of experience. Amy has led strategic business planning, organizational restructuring, process design and integration, and human resources across many industries, including technology, healthcare, and the nonprofit sector. She has held key leadership roles in organizations ranging from Fortune 50 companies to tech startups, driving solution-focused outcomes that foster growth. Currently Chief of Staff at Denim Health, Amy has previously served as Chief Administrative Officer at Girl Scouts of the USA and Operations Strategy Executive at Iodine Software. She holds a degree in Business Administration from Marist College.",
  },
]
